...
ASS Timer is a small Windows app that sends the current **minute-of-hour** or **second-of-minute** to **OBS Advanced Scene Switcher (ASS)** using a **generic WebSocket connection** (not the OBS WebSocket protocol).
